...
import SearchVolunteer from "./components/SearchVolunteer/SearchVolunteer";
function App() {
      ...
      <Router>
        <>
          ...
          <Routes>
            ...
            <Route path="/search-volunteer" element={<SearchVolunteer />} />
            ...
            <Route exact path="/dashboard/create-volunteer" element={<VolunteerForm></VolunteerForm>}></Route>
