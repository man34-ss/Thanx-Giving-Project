            ...
            <div className="card mb-3 mx-auto my-5 startup_form">
                <div className="row g-0">
                    <div className="col-md-5 col-sm-12">
                        <img src="https://thumbs.dreamstime.com/z/reminder-paper-word-review-vector-vector-illustration-eps-file-available-see-more-images-related-reminder-paper-word-review-vector-123349266.jpg?w=360" className="img-fluid rounded-start review_image" alt="review-image" />
                    </div>
                    <div className="col-md-7 col-sm-12">
                        <div className="card-body">
                            <h5 className="card-title text-center">Caampaign Rating Form</h5>
                            <form className="my-4">
                                ...
                                <div className="mb-3">
                                    <label for="exampleInputPassword1" className="form-label text-muted">To the website of the Campaign?</label>
                                ...
                                <div className="mb-3">
                                    <label for="exampleInputPassword1" className="form-label text-muted">Rate overall experiance?</label>
