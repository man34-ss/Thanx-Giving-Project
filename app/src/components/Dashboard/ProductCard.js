        ...
        <div className="container my-5">
            <div className="row">
                ...
                <div className="col-lg-5 col-md-12 col-sm-12 mb-3">
                    <label className="startup_label"> Name</label>
                    <p className="startup_label_desc">{props.data.Name}</p>
                    {/* <p className="startup_label_desc">Your Static Startup Name</p> */}
                    ...
                    <hr className="startup_label_hr" />
                    <label className="startup_label"> Category</label>
                    <p className="startup_label_desc">{props.data.Category}</p>
                    <hr className="startup_label_hr" />
                    <label className="startup_label"> Vision</label>
                    ...
                    <hr className="startup_label_hr" />
                    {/* <label className="startup_label">How they are using donation</label>
                    ...
                    <div className="card product_card">
                        <div className="card-body">
                            {!isbacker ? (<><h2 className="product_card_title">₹ {props.data.Current}</h2>
                                ...
                                <p className="product_card_desc">Donar</p>
                                <button type="button" onClick={() => setIsBacker(true)} className="btn backer__btn">Donate</button></>) : (
                                <>
